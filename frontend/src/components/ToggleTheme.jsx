...
function ToggleTheme() {
  ...
  return (
    <div className="bg-gray-100 dark:bg-slate-900 w-[90%] mx-auto rounded-md py-3">
      <div className="flex items-center justify-center w-full gap-4">
        ...
        >
          ...
          <div className={`absolute cursor-pointer bottom-0 left-0 top-0 right-0 bg-indigo-700 rounded-full lg:hover:bg-gray-500 transition-all duration-300 ease-in-out before:absolute before:h-5 before:w-5 before:bg-white before:top-1 before:left-1 before:rounded-full ${theme === 'dark' ? 'before:translate-x-5' : 'before:translate-x-0'} before:transition-all before:duration-300 before:ease-in-out`} />
        </label>
